...
const MultiImageUpload3 = () => {
 ...
 console.log(result)
 if(result.status){
    setCurrentImages(result.banners.set3)
...
getCurrentImages()
  ...
  const handleUpload = async (data) => {
    ...
    try {
      ...
      const res = await postData("api/products/editbanners3", formData);
...
export default MultiImageUpload3;
