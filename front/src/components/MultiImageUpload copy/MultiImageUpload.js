...
const MultiImageUpload2 = () => {
 ...
 console.log(result)
 if(result.status){
    setCurrentImages(result.banners.set2)
...
getCurrentImages()
  ...
  const handleUpload = async (data) => {
    ...
    try {
      ...
      const res = await postData("api/products/editbanners2", formData);
...
export default MultiImageUpload2;
